    ...
    <div class="pc-platform">
      ...
      <div class="pc-platform-row">
        ...
        <main class="pc-platform-main">
          ...
          <%
            banda_cfg = Prettycore.SysAdmin.get_config()
            banda_texto = banda_cfg.banda_texto || "¿Tienes alguna idea de app web y no sabes cómo hacerla realidad? CONTÁCTANOS"
            banda_color = banda_cfg.banda_color || "#4f46e5"
          %>
